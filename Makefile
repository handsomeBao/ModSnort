...
ACLOCAL = ${SHELL} /home/mrbao/snort-2.9.8.0/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/mrbao/snort-2.9.8.0/missing autoconf
AUTOHEADER = ${SHELL} /home/mrbao/snort-2.9.8.0/missing autoheader
AUTOMAKE = ${SHELL} /home/mrbao/snort-2.9.8.0/missing automake-1.14
AWK = mawk
CC = gcc
...
CPP = gcc -E
CPPFLAGS = -I/usr/local/include -DGRE -DMPLS -DPPM_MGR -DNDEBUG -DSOURCEFIRE -DPPM_MGR -DENABLE_REACT -DENABLE_RESPOND -DENABLE_RESPONSE3 -DSF_WCHAR -DTARGET_BASED -DPERF_PROFILING -DPERF_PROFILING -DSNORT_RELOAD -DNO_NON_ETHER_DECODER -DNORMALIZER -DACTIVE_RESPONSE
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LDFLAGS =  -lpcre -L/usr/local/lib -ldnet
LEX = flex
LIBOBJS = 
LIBS = -lz -ldaq_static -ldnet -lpcre -lpcap -lnsl -lm -lm  -lcrypto -ldl -L/usr/local/lib -ldaq_static_modules  -lsfbpf -lpcap -lsfbpf -lpcap -lz -lpthread -lpthread -lpthread
...
LUA_CFLAGS = 
LUA_LIBS = 
MAKEINFO = ${SHELL} /home/mrbao/snort-2.9.8.0/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
XCCFLAGS = 
YACC = bison -y
abs_builddir = /home/mrbao/snort-2.9.8.0
abs_srcdir = /home/mrbao/snort-2.9.8.0
abs_top_builddir = /home/mrbao/snort-2.9.8.0
abs_top_srcdir = /home/mrbao/snort-2.9.8.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/mrbao/snort-2.9.8.0/install-sh
